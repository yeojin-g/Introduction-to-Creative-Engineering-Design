...
// get a distance reading from the USS
  ...
  dist_ema = alpha*dist_raw+(1-alpha)*dist_ema; //Add EMA Filter
...
if(dist_raw <= 180.0) {
     ...
     myservo.writeMicroseconds((dist_raw-180)*(1850/180)+550); // Servo position proportion according to distance
  }
  else {
