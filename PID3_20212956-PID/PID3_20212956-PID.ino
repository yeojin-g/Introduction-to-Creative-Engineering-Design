...
// Servo range
#define _DUTY_MIN 550 // 서보의 최소 각도값
#define _DUTY_NEU 1680 // 서보의 중간 각도값
#define _DUTY_MAX 2400 // 서보의 최대 각도

// Servo speed control
#define _SERVO_ANGLE 60  // 서보 각도 설정
#define _SERVO_SPEED 450  // 서보의 속도 설정
...
// PID parameters
#define _KP 1.8 // 비례 제어 값
#define _KD 76 // 미분 제어 값
#define _KI 0.01 // 적분 제어 값
...
float calcDistance(short value){ // return value unit: mm
  ...
  return 100.0 + 300.0 / (B - A) * (val - A);  // 센서가 읽은 거리를 이용한 실제 거리 반환
}
